...
export default function Updater(): null {
  ...
  useEffect(() => {
    ...
    dispatch(
      actions.multicall.fetchingMulticallResults({
        chainId,
        ...
        promise
          .then(({ results: returnData, blockNumber: fetchBlockNumber }) => {
            ...
            if (Object.keys(results).length > 0)
              dispatch(
                actions.multicall.updateMulticallResults({
                  chainId,
                  results,
            ...
            if (erroredCalls.length > 0) {
              ...
              dispatch(
                actions.multicall.errorFetchingMulticallResults({
                  chainId,
            ...
            if (fetchBlockNumber > latestBlockNumber) {
              dispatch(actions.application.updateBlockNumber({ chainId, blockNumber: fetchBlockNumber }));
            }
          })
          .catch((error: any) => {
